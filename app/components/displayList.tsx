...
const CountryList: React.FC<Props> = ({ countries, isTheme }) => {
  if (isTheme)
    return (
      <>
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 cursor-pointer">
          <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 justify-center items-center">
            {countries.map((country) => (
              ...
              >
                <div
                  className="w-full h-[450px] max-w-fix overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 cursor-pointer lightModeNav"
                  id="cardBody"
                >
                  <img
        ...
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 cursor-pointer">
          <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 justify-center items-center">
            {countries.map((country) => (
              ...
              >
                <div
                  className="w-full h-[450px] max-w-xs overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 cursor-pointer darkModeNav"
                  id="cardBody"
                >
                  <img
                    className="object-cover w-full h-56"
